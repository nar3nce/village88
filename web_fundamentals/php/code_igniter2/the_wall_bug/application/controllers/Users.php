        ...
        else 
        {
            ...
            if($result == "success") 
            {
                foreach($user as $user_){
                    $this->session->set_userdata(array('user_id'=>$user_['id'], 'first_name'=>$user_['first_name']));      
                }
                redirect("wall");
    ...
    */
    public function process_registration() 
    {
        ...
        else
        {
            ...
            foreach($new_user as $new_user_){
                $this->session->set_userdata(array('user_id' => $new_user_["id"], 'first_name'=>$new_user_['first_name']));
            }
            redirect("wall");
        }
    }
