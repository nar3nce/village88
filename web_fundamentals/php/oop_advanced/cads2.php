...
class Card{
    ...
    function Deal(){
        ...
        $this->tmp = array_slice($this->standard_cards,13);
        $this->remaining_cards = $this->tmp;
        return $this;
    }

    function refreshRemainingCard(){
        unset($this->remaining_cards);
        return $this;
    }
    ...
    function DisplayRemainingCards(){
        foreach($this->remaining_cards as  $remaining_cards){
            echo $remaining_cards."<br>";
        }
    }
}   
...
//$c = new Card();
//$c->shuffle()->Deal()->DisplayCards();
//echo"<br>";
//$c->DisplayRemainingCards();

$player1 = new Player("narence");
$player1->shuffle()->Deal()->DisplayRemainingCards();
$player1->refreshRemainingCard()->Deal()->DisplayRemainingCards();
